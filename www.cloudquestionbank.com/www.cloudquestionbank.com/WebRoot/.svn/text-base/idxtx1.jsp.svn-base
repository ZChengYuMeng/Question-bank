...
if($sor5!=0){
	...
	$.each(obj.listTwo,function(i,o){
		twoquser[twoquser.length]=o[3];
	});
	//
    ...
    series : [
        {
            ...
            data : [
                {name:'other', value:(100-twoquser[0]), itemStyle : labelBottom},
                {name:'专业技能型', value:twoquser[0],itemStyle : labelTop}
            ]
        },
        {
            type : 'pie',
            ...
            itemStyle : labelFromatter,
            data : [
                {name:'other', value:(100-twoquser[1]), itemStyle : labelBottom},
                {name:'课程复习型', value:twoquser[1],itemStyle : labelTop}
            ]
        },
        {
            type : 'pie',
            ...
            itemStyle : labelFromatter,
            data : [
                {name:'other', value:twoquser[2], itemStyle : labelBottom},
                {name:'模拟真题型', value:65,itemStyle : labelTop}
            ]
        }
    ]
}) ;
