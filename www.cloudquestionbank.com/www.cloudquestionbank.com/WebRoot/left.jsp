...
<script type="text/javascript" src="ST/yanglu/css/jquery.min.js"></script>
<script type="text/javascript" src="ST/yanglu/js/nav.js"></script>
<script src="/demos/googlegg.js"></script>
  ...
  <body>
   <div class="nav" >
	<div class="nav-top">
		<div id="mini" style="border-bottom:1px solid rgba(255,255,255,.1)"><img src="ST/yanglu/images/mini.png" ></div>
	</div>
	<ul>
		<li class="nav-item">
