...
<title>4款echarts.js扁平图形统计图表代码</title>
...
<!-- <script type="text/javascript" src="ST/yanglu/js/index1.js"></script> -->
</body>
...
$(function(){
   ...
   var $avg5=0;
   var $avg6=0;
  $.post("<%=request.getContextPath()%>/Index_tuxing?guest.guestId="+<%=session.getAttribute("uid")%>,success,"json");
